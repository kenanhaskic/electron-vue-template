...
function emptyMainOutput() {
  return _emptyMainOutput.apply(this, arguments);
}

function _emptyMainOutput() {
  _emptyMainOutput = (0, _bluebirdLst().coroutine)(function* () {
...
class DevRunner {
  ...
  startMainCompilation(hmrServer) {
    return (0, _bluebirdLst().coroutine)(function* () {
      const mainConfig = yield (0, _main2().configure)("main", {
        production: false,
        autoClean: false,
        forkTsCheckerLogger: {
          info: () => {// ignore
...
function _main() {
  _main = (0, _bluebirdLst().coroutine)(function* () {
