...
function configureDll(_x) {
  return _configureDll.apply(this, arguments);
}

function _configureDll() {
  _configureDll = (0, _bluebirdLst().coroutine)(function* (configurator) {
...
function getDllAssets(_x2, _x3) {
  return _getDllAssets.apply(this, arguments);
} function _getDllAssets() {
  _getDllAssets = (0, _bluebirdLst().coroutine)(function* (dllDir, configurator) {
