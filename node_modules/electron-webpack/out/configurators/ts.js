...
function configureTypescript(_x) {
  return _configureTypescript.apply(this, arguments);
} function _configureTypescript() {
  _configureTypescript = (0, _bluebirdLst().coroutine)(function* (configurator) {
