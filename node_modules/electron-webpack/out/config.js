...
function getElectronWebpackConfiguration(_x) {
  return _getElectronWebpackConfiguration.apply(this, arguments);
} function _getElectronWebpackConfiguration() {
  _getElectronWebpackConfiguration = (0, _bluebirdLst().coroutine)(function* (context) {
