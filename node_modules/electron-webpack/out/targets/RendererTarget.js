...
class RendererTarget extends BaseRendererTarget {
  ...
  configurePlugins(configurator) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      if (yield (0, _util().statOrNull)(customTemplateFile)) {
        template = yield (0, _fsExtraP().readFile)(customTemplateFile, {
          encoding: "utf8"
        });
      } else {
      ...
      configurator.plugins.push(new HtmlWebpackPlugin({
        filename: "index.html",
        template: yield generateIndexFile(configurator, nodeModulePath, template),
        minify: false,
...
function computeTitle(_x) {
  return _computeTitle.apply(this, arguments);
}

function _computeTitle() {
  _computeTitle = (0, _bluebirdLst().coroutine)(function* (configurator) {
...
function generateIndexFile(_x2, _x3, _x4) {
  return _generateIndexFile.apply(this, arguments);
} function _generateIndexFile() {
  _generateIndexFile = (0, _bluebirdLst().coroutine)(function* (configurator, nodeModulePath, template) {
    ...
    yield (0, _fsExtraP().outputFile)(filePath, html);
